...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/recover-identity.vue?vue&type=template&id=4cba05da&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  })])], 1), _vm._ssrNode(" <div class=\"t_b\"></div> "), _vm._ssrNode("<div class=\"link_home\">", "</div>", [_c('ion-icon', {
    staticClass: "fa-solid fa-circle-question"
  })], 1)], 2)])], 2)])]), _vm._ssrNode(" <section class=\"main_part\"><div class=\"container-fluid\"><div class=\"col-md-12\"><div class=\"title_iden\"><h6>Recover identity</h6> <p>You can open multichain wallets under this identity like ETH,BTC,COSMOS and EOS.</p></div> <div class=\"form_part\"><form action><div class=\"in_group\"><label> Mnemonic</label> <textarea name id cols=\"30\" placeholder=\"Enter mnemonic separated by space\" rows=\"4\"></textarea></div> <div class=\"in_group pb-0\"><label> Set Passwrod</label> <input type=\"password\" placeholder=\"Enter Password\"></div> <div class=\"in_group pt-0\"><input type=\"password\" id=\"pass\" placeholder=\"Confirm Password\"> <i toggle=\"#pass\" class=\"fa-regular fa-eye toggle-password\"></i></div> <h6 class=\"mt-2\" style=\"font-size: 12px;\">Password hint </h6> <div class=\"in_group pt-1\"><input type=\"text\" id=\"hint\" placeholder=\"Password hint\"></div></form></div></div></div></section> <section class=\"footer py-3\"><div class=\"container-fluid\"><div class=\"row\"><div class=\"col-md-12\"><div class=\"f_buttons\"><div class=\"d-flex align-items-center my-2\"><input type=\"checkbox\" name id=\"check\"><label for=\"check\" class=\"ms-2 mb-0\" style=\"font-size: 12px; margin-bottom: 5px;\">I have agreed to the terms of\r\n                                service</label></div> <button type=\"button\" class=\"btn_backup\">Confirm</button></div></div></div></div></section>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/recover-identity.vue?vue&type=template&id=4cba05da&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/recover-identity.vue?vue&type=script&lang=js&


/* harmony default export */ var recover_identityvue_type_script_lang_js_ = ({
  head: {
...
// CONCATENATED MODULE: ./pages/recover-identity.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_recover_identityvue_type_script_lang_js_ = (recover_identityvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/recover-identity.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_recover_identityvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var recover_identity = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=recover-identity.js.map