...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/transaction.vue?vue&type=template&id=507bacac&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  })])], 1), _vm._ssrNode(" <div class=\"t_b\"><h6>Transaction records</h6></div> <div class=\"link_home\"><button type=\"button\" data-bs-toggle=\"offcanvas\" data-bs-target=\"#setings_option\" aria-controls=\"offcanvasBottom\" class=\"btn_cancle\" style=\"color: #000;font-size: 20px;\"><i class=\"fa-solid fa-filter\"></i></button></div>")], 2)])], 2)])]), _vm._ssrNode(" <section class=\"main_part bg-white\"><div class=\"container-fluid\"><div class=\"col-md-12\"><div class=\"no_data\"><div><img src=\"/images/no-data-availible-100.png\" loading=\"lazy\" alt class=\"img-fluid\"> <p>No Data </p></div></div></div></div></section> "), _c('Footer'), _vm._ssrNode(" <div tabindex=\"-1\" id=\"setings_option\" aria-labelledby=\"offcanvasBottomLabel\" class=\"offcanvas offcanvas-bottom\"><div class=\"offcanvas-header\"><div class=\"link_home\" style=\"width: 100%;\"><div class=\"s_collapse\" style=\"width: 100%;\"><form action class=\"p-0 m-0\" style=\"width: 100%;\"><input type=\"text\" placeholder=\"Input token name\" name id style=\"border-radius: 20px;\"> <button type=\"button\"><i class=\"fa-solid fa-magnifying-glass\"></i></button></form></div></div> <button type=\"button\" data-bs-dismiss=\"offcanvas\" aria-label=\"Close\" class=\"btn-close\"></button></div> <div class=\"offcanvas-body small\"><ul style=\"background-color: #fff;\"><li><div class=\"_layer\"><a type=\"button\" class=\"_net_btn active\"><div class=\"d-flex align-items-center\"><p>All </p></div> <i class=\"fa-solid fa-check\"></i></a></div></li> <li><div class=\"_layer\"><a type=\"button\" class=\"_net_btn\"><div class=\"d-flex align-items-center\"><p>BRICS</p></div> <i class=\"fa-solid fa-check\"></i></a></div></li> <li><div class=\"_layer\"><a type=\"button\" class=\"_net_btn\"><div class=\"d-flex align-items-center\"><p>ETH</p></div> <i class=\"fa-solid fa-check\"></i></a></div></li> <li><div class=\"_layer\"><a type=\"button\" class=\"_net_btn\"><div class=\"d-flex align-items-center\"><p>USDT </p></div> <i class=\"fa-solid fa-check\"></i></a></div></li></ul></div></div> <div id=\"m_modal\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\" class=\"modal fade\"><div class=\"modal-dialog modal-dialog-centered\"><div class=\"modal-content\"><div class=\"modal-body\"><div class=\"m_contents\"><h6>Messages titles</h6> <div class=\"m_div\"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis suscipit odio dolorem!\r\n                                Laudantium dolore at perferendis. Aperiam vitae sequi eligendi dolor, maiores quas saepe\r\n                                tenetur ratione? Facilis totam dicta dolores!</p></div></div></div> <div class=\"modal-footer d-flex align-items-center\"><button type=\"button\" data-bs-dismiss=\"modal\" class=\"btn btn_backup\">Close</button></div></div></div></div>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/wallet/transaction.vue?vue&type=template&id=507bacac&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/transaction.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/wallet/transaction.vue?vue&type=script&lang=js&
 /* harmony default export */ var wallet_transactionvue_type_script_lang_js_ = (transactionvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/wallet/transaction.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  wallet_transactionvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
