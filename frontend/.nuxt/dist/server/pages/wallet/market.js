...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/market.vue?vue&type=template&id=07ebb4a8&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<section class=\"top_bar\">", "</section>", [_vm._ssrNode("<div class=\"container-fluid\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_c('center', [_c('Loader')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-md-12\">", "</div>", [_vm._ssrNode("<div class=\"top_bar_home\">", "</div>", [_vm._ssrNode("<div class=\"link_home\" style=\"opacity: 0;\"><a href=\"scan.html\" type=\"button\"><i class=\"fa-solid fa-headphone\"></i></a></div> "), _vm._ssrNode("<div class=\"_tab_button t_b\">", "</div>", [_c('nuxt-link', {
    staticClass: "_tab tb_m",
    attrs: {
      "to": "/wallet/trade",
      "type": "button"
    }
  }, [_vm._v("Trade")]), _vm._ssrNode(" "), _c('nuxt-link', {
    staticClass: "_tab tb_m active",
    attrs: {
      "to": "/wallet/market",
      "type": "button"
    }
  }, [_vm._v("Markets")])], 2), _vm._ssrNode(" <div class=\"link_home\"><a data-bs-toggle=\"collapse\" href=\"#search_\" role=\"button\" aria-expanded=\"false\" aria-controls=\"search_\" type=\"button\"><i class=\"fa-solid fa-magnifying-glass\"></i></a></div>")], 2)])], 2)])]), _vm._ssrNode(" <section class=\"main_part\"><div class=\"container-fluid\"><div class=\"col-md-12\"><div id=\"search_\" class=\"collapse\"><div class=\"s_collapse\"><form action><input type=\"text\" placeholder=\"Input token name\" name id> <button type=\"button\"><i class=\"fa-solid fa-magnifying-glass\"></i></button></form></div></div> <div class=\"market_buttons\"><button class=\"m_filter active\">Watchlist</button> <button class=\"m_filter\">Market Value</button> <button class=\"m_filter\">DeFi</button></div> <div><table class=\"table mb-0\"><thead><tr><th>Market Value</th> <th>Price</th> <th>Change</th></tr></thead></table></div> <div class=\"table_list\"><table class=\"table\"><tbody><tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                    $0.514365\r\n                                </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>SUKU</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                    $0.514365\r\n                                </td> <td><div class=\"alert alert-success px-2 py-1\" style=\"width: fit-content;\"> 5.23%</div></td></tr></tbody></table></div></div></div></section> "), _c('Footer'), _vm._ssrNode(" <div tabindex=\"-1\" id=\"chart_graph\" aria-labelledby=\"offcanvasBottomLabel\" class=\"offcanvas coin_select offcanvas-bottom\"><div class=\"offcanvas-header\"><button type=\"button\" data-bs-dismiss=\"offcanvas\" aria-label=\"Close\" class=\"btn-close text-black\"></button> <h5 id=\"offcanvasBottomLabel\" class=\"offcanvas-title text-black\">BTC </h5> <div><button type=\"button\" class=\"btn_wishlist active\"><i class=\"fa-regular fa-star\"></i></button></div></div> <div class=\"offcanvas-body small\"><div><table class=\"table\"><tbody><tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr></tbody></table></div> <div class=\"d_filter\"><button type=\"button\">1D</button> <button type=\"button\">1W</button> <button type=\"button\">1M</button> <button type=\"button\">1year</button> <button type=\"button\">All</button></div> <div class=\"l_chart\"><canvas id=\"myChart\"></canvas></div> <div><table class=\"table\"><tbody><tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr> <tr data-bs-toggle=\"offcanvas\" data-bs-target=\"#chart_graph\" aria-controls=\"offcanvasBottom\"><td><h6>REP</h6> <p>#42 <span>$5.65M</span></p></td> <td>\r\n                                $0.514365\r\n                            </td> <td><div class=\"alert alert-danger px-2 py-1\" style=\"width: fit-content;\"> -5.23%</div></td></tr></tbody></table></div></div></div>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/wallet/market.vue?vue&type=template&id=07ebb4a8&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/market.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/wallet/market.vue?vue&type=script&lang=js&
 /* harmony default export */ var wallet_marketvue_type_script_lang_js_ = (marketvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/wallet/market.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  wallet_marketvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
