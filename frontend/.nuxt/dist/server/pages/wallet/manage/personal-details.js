...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/manage/personal-details.vue?vue&type=template&id=a1dacda8&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }), _vm._v(" "), _c('p', [_vm._v("Pronay")])]), _vm._v(" "), _c('i', {
    staticClass: "fa-chevron-right fa-solid"
  })])], 1)])]), _vm._ssrNode(" <ul style=\"background-color: #fff;\"><li><div class=\"_layer\"><a type=\"button\" class=\"_net_btn active push_backup\"><div class=\"d-flex align-items-center\"><p>Backup </p></div> <div class=\"d-flex align-items-center\"><span style=\"font-size: 12px;\">Please backup</span> <i class=\"fa-chevron-right fa-solid\"></i></div></a></div></li></ul> <p style=\"font-size: 12px;\">Backup your wallet to recover your multi assets under the identity\r\n                        wallet</p> "), _vm._ssrNode("<ul style=\"background-color: #fff;\">", "</ul>", [_vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<div class=\"_layer\">", "</div>", [_c('nuxt-link', {
    staticClass: "_net_btn active",
    attrs: {
      "to": "/wallet/manage/add-coin",
      "type": "button"
    }
  }, [_c('div', {
    staticClass: "d-flex align-items-center"
  }, [_c('p', [_vm._v("Add Coin")])]), _vm._v(" "), _c('i', {
    staticClass: "fa-chevron-right fa-solid"
  })])], 1)]), _vm._ssrNode(" <li><div class=\"_layer\"><a type=\"button\" class=\"_net_btn active pass_h\"><div class=\"d-flex align-items-center\"><p>Password hint</p></div> <i class=\"fa-chevron-right fa-solid\"></i></a></div></li> <li><div class=\"_layer justify-content-center\"><a href type=\"button\" class=\"_net_btn active justify-content-center\"><div class=\"d-flex align-items-center\"><p style=\"color: red;\">Quit</p></div></a></div></li>")], 2)], 2)])])]), _vm._ssrNode(" <div class=\"pass_modal pass_id\"><div class=\"p_modal\"><form action><h6>Enter password</h6> <div class=\"in_group\"><input type=\"password\" placeholder=\"Password\" name=\"password\" id=\"password-field\" class=\"img-fluid\"> <i toggle=\"#password-field\" class=\"fa-regular fa-eye toggle-password\"></i></div> <div class=\"d-flex align-items-center justify-content-center my_modal_footer\"><button type=\"button\" class=\"btn_cancle\">Cancel</button> <button type=\"button\" class=\"btn_cancle confirm_pass\">Confirm</button></div></form></div></div> <div class=\"pass_modal pass_hint\"><div class=\"p_modal\"><form action><h6>Passwod Hint </h6> <div class=\"in_group\"><input type=\"password\" placeholder=\"Password hint\" value=\"Test_pass\" name=\"hint\" id=\"password-hint\" class=\"img-fluid\"> <i toggle=\"#password-hint\" class=\"fa-regular fa-eye toggle-password\"></i></div> <div class=\"d-flex align-items-center justify-content-center my_modal_footer\"><button type=\"button\" class=\"btn_cancle\">Cancel</button> <button type=\"button\" class=\"btn_cancle\">Confirm</button></div></form></div></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/wallet/manage/personal-details.vue?vue&type=template&id=a1dacda8&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/manage/personal-details.vue?vue&type=script&lang=js&


/* harmony default export */ var personal_detailsvue_type_script_lang_js_ = ({
  head: {
    title: 'Personal Deails'
  },
  components: {
...
// CONCATENATED MODULE: ./pages/wallet/manage/personal-details.vue?vue&type=script&lang=js&
 /* harmony default export */ var manage_personal_detailsvue_type_script_lang_js_ = (personal_detailsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/wallet/manage/personal-details.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  manage_personal_detailsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
