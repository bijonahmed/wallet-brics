...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/user/settings/dap-settings.vue?vue&type=template&id=25616b30&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  })])], 1), _vm._ssrNode(" <div class=\"t_b\"><h6>DApp settings</h6></div> <div class=\"link_home\"></div>")], 2)])], 2)])]), _vm._ssrNode(" <section class=\"main_part\"><div class=\"container-fluid\"><div class=\"col-md-12\"><div class=\"layer settings_\"><ul><li><div class=\"_layer\"><a href=\"#\" type=\"button\" class=\"_net_btn active\"><div class=\"d-flex align-items-center\"><p>DApp Privacy Mode</p></div> <div><div class=\"checkboxes__row\"><div class=\"checkboxes__item\"><label class=\"checkbox style-e\"><input type=\"checkbox\" checked=\"checked\"> <div class=\"checkbox__checkmark\"></div></label></div></div></div></a></div></li></ul> <ul style=\"background-color: #fff;\"><li><div class=\"_layer\"><a href=\"#\" type=\"button\" class=\"_net_btn active\"><div class=\"d-flex align-items-center\"><p style=\"color: red;\">Clean Up Network Cache</p></div></a></div></li></ul> <ul style=\"background-color: #fff;\"><li><div class=\"_layer\"><a href=\"#\" type=\"button\" class=\"_net_btn active\"><div class=\"d-flex align-items-center\"><p style=\"color: red;\">Disconnect the wallet from Dapps</p></div></a></div></li></ul></div></div></div></section> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/wallet/user/settings/dap-settings.vue?vue&type=template&id=25616b30&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/user/settings/dap-settings.vue?vue&type=script&lang=js&


/* harmony default export */ var dap_settingsvue_type_script_lang_js_ = ({
  head: {
    title: 'Dap Setting'
  },
  components: {
...
// CONCATENATED MODULE: ./pages/wallet/user/settings/dap-settings.vue?vue&type=script&lang=js&
 /* harmony default export */ var settings_dap_settingsvue_type_script_lang_js_ = (dap_settingsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/wallet/user/settings/dap-settings.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  settings_dap_settingsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var dap_settings = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=dap-settings.js.map