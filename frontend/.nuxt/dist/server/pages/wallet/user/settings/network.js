...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/user/settings/network.vue?vue&type=template&id=c70ac306&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  })])], 1), _vm._ssrNode(" <div class=\"t_b\"><h6>Network settings</h6></div> <div class=\"link_home\"></div>")], 2)])], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_part\">", "</section>", [_vm._ssrNode("<div class=\"container-fluid\">", "</div>", [_vm._ssrNode("<div class=\"col-md-12\">", "</div>", [_vm._ssrNode("<div class=\"layer settings_\">", "</div>", [_vm._ssrNode("<ul class=\"mt-0 pt-0\" style=\"background-color: #fff;\">", "</ul>", [_vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<div class=\"_layer\">", "</div>", [_vm._ssrNode("<a type=\"button\" class=\"_net_btn active\">", "</a>", [_vm._ssrNode("<div class=\"d-flex align-items-center\"><p>ETHEREUM </p></div> "), _vm._ssrNode("<div class=\"d-flex align-items-center\">", "</div>", [_vm._ssrNode("<p style=\"font-size: 10px;\">Ethereum</p> "), _c('ion-icon', {
    staticClass: "fa-solid fa-chevron-right"
  })], 2)], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<div class=\"_layer\">", "</div>", [_vm._ssrNode("<a type=\"button\" class=\"_net_btn\">", "</a>", [_vm._ssrNode("<div class=\"d-flex align-items-center\"><p>BITCOIN </p></div> "), _vm._ssrNode("<div class=\"d-flex align-items-center\">", "</div>", [_vm._ssrNode("<p style=\"font-size: 10px;\">Bitcoin</p> "), _c('ion-icon', {
    staticClass: "fa-solid fa-chevron-right"
  })], 2)], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<div class=\"_layer\">", "</div>", [_vm._ssrNode("<a type=\"button\" class=\"_net_btn\">", "</a>", [_vm._ssrNode("<div class=\"d-flex align-items-center\"><p>LITECOIN </p></div> "), _vm._ssrNode("<div class=\"d-flex align-items-center\">", "</div>", [_vm._ssrNode("<p style=\"font-size: 10px;\">litecoin</p> "), _c('ion-icon', {
    staticClass: "fa-solid fa-chevron-right"
  })], 2)], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<div class=\"_layer\">", "</div>", [_vm._ssrNode("<a type=\"button\" class=\"_net_btn\">", "</a>", [_vm._ssrNode("<div class=\"d-flex align-items-center\"><p>COSMOS </p></div> "), _vm._ssrNode("<div class=\"d-flex align-items-center\">", "</div>", [_vm._ssrNode("<p style=\"font-size: 10px;\">Cosmos</p> "), _c('ion-icon', {
    staticClass: "fa-solid fa-chevron-right"
  })], 2)], 2)])])], 2)])])])]), _vm._ssrNode(" "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/wallet/user/settings/network.vue?vue&type=template&id=c70ac306&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/user/settings/network.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/wallet/user/settings/network.vue?vue&type=script&lang=js&
 /* harmony default export */ var settings_networkvue_type_script_lang_js_ = (networkvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/wallet/user/settings/network.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  settings_networkvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
