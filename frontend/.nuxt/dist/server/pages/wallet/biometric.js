...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/biometric.vue?vue&type=template&id=0e0fc952&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  })])], 1), _vm._ssrNode(" <div class=\"t_b\"><h6>Biometric Verification</h6></div> <div class=\"link_home\"></div>")], 2)])], 2)])]), _vm._ssrNode(" <section class=\"main_part\"><div class=\"container-fluid\"><div class=\"col-md-12\"><div class=\"ex_box\" style=\"background-color: transparent;\"><div class=\"finger_print\"><i class=\"fa-solid fa-fingerprint\"></i></div> <div class=\"d-flex justify-content-between bio_metric\" style=\"background-color: #fff;\"><h6>Tuch ID </h6> <div><div class=\"checkboxes__row\"><div class=\"checkboxes__item\"><label class=\"checkbox style-e\"><input type=\"checkbox\" id=\"check2\"> <div class=\"checkbox__checkmark\"></div></label></div></div></div></div> <div class=\"bio_txt\"><p>Introduction to biometric verification</p> <p>Your wallet password will be encrypted and stored in the Keychain/ Keystore of your mobile\r\n                            device, biometrics (fringerprint or facial) will decrypt the password for transaction\r\n                            esecution.</p> <p>Please backup the password immediately after enabling biometric verification feature. To\r\n                            reset the password, you can reimport the wallet using Mnemonic Phrase or Private Key.</p> <p>Security reminder</p> <p>Please check on the security level of your mobile device's biometric verification features\r\n                            for large assets transfer, please execute by manually inputting you password</p> <p>Please refrain from enabling biometric verification shared mobile devices</p> <p>Disclaimer</p> <p>The security levels for biometric verification very among mobile device, users are\r\n                            recommended to proceed with caution. BRICS token will not be held liable for any risks or\r\n                            loss arising from vulnerabilities in the biometric verification feature.</p></div></div></div></div></section>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/wallet/biometric.vue?vue&type=template&id=0e0fc952&

// EXTERNAL MODULE: ./components/Loader.vue + 4 modules
var Loader = __webpack_require__(32);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wallet/biometric.vue?vue&type=script&lang=js&

/* harmony default export */ var biometricvue_type_script_lang_js_ = ({
  head: {
    title: 'Biometric'
  },
  components: {
...
// CONCATENATED MODULE: ./pages/wallet/biometric.vue?vue&type=script&lang=js&
 /* harmony default export */ var wallet_biometricvue_type_script_lang_js_ = (biometricvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/wallet/biometric.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  wallet_biometricvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var biometric = __webpack_exports__["default"] = (component.exports);
