         ...
         e.$el = a(b),
          ...
          e), e.options = a.extend(a.quiz.defaultOptions, 
            ...
            e.methods = { 
                ...
                gameOver: function (b) { if (0 === a(l).length) { 
                        var c = ""; 
                        c += '<div id="' + l.substr(1) + '">', 
                ...
                finish: function () { 
                    ...
                    a("#quiz-results").html("You got " + n + " out of " + g + " correct!"), "function" == typeof e.options.finishCallback && e.options.finishCallback() 
                }, 
                ...
                reset: function () { 
                    o = !1, m = 1, n = 0, a(".answers a").removeClass("correct incorrect"), 
            ...
            a.quiz.defaultOptions = { allowIncorrect: !0, counter: !0, counterFormat: "%current/%total", 
